...
//    int racketYPosition;  // top left corner of the racket
    ...
    public GameEngine(Context context, int w, int h) {
        ...
        this.ball = new ballFeature(this.screenWidth / 2, this.screenHeight / 2 - 400);
        this.racket = new racketFeature(350, 1200);
...
//        this.racketYPosition = 1200;
    ...
    public void updatePositions() {
        ...
        if (directionBallIsMoving == "down") {
            ...
            this.ball.setBallXPos(this.ball.getBallXPos()+25);
...
//                this.racketYPosition = 1200;
        ...
        if (directionBallIsMoving == "up") {
            //this.ballYPosition = this.ballYPosition - 25;
          this.ball.setBallYPos(this.ball.getBallYPos());
        ...
        if (
                ...
                (this.ball.getBallYPos()) >= (this.racket.getRacketXPos())&&
    ...
    public void redrawSprites() {
        if (this.holder.getSurface().isValid()) {
            ...
            this.canvas.drawRect(
                    this.ball.ballXPos,
                    this.ball.ballYPos,
                    this.ball.ballXPos + 50,
                    this.ball.ballYPos + 50,
                    paintbrush);

            // 2. Draw the racket

            paintbrush.setColor(Color.YELLOW);
            this.canvas.drawRect(this.racket.racketXPos,
                    this.racket.racketYPos,
                    this.ball.ballXPos + 200,     // 400 is width of racket
                    this.ball.ballYPos + 650,    // 50 is height of racket
                    paintbrush);
            paintbrush.setColor(Color.WHITE);
            ...
            paintbrush.setTextSize(70);
            canvas.drawText("Score: " + this.score, 20, 200, paintbrush);


            paintbrush.setTextSize(70);
            canvas.drawText("Lives Remaining" + this.lives, 20, 500, paintbrush);
